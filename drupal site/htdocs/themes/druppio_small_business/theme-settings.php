...
function druppio_small_business_form_system_theme_settings_validate(&$form, FormStateInterface $form_state) {
 ...
 */
function druppio_small_business_form_system_theme_settings_submit(&$form, FormStateInterface $form_state) {
