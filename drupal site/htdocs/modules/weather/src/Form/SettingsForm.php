    ...
    foreach ($displays as $display) {
      ...
      foreach ($locations as $locationId) {
        ...
        $form['system_displays'][$display_number]['#rows'][] = [
          Link::fromTextAndUrl(
            ...
            Url::fromRoute('entity.weather_display_place.edit_form', [
      ...
      $form['system_displays'][$display_number]['#rows'][] = [
        'link' => Link::fromTextAndUrl(
          ...
          Url::fromRoute('entity.weather_display_place.add_form', ['display_type' => WeatherDisplayInterface::SYSTEM_WIDE_TYPE, 'display_number' => $display_number])
        ),
        '#wrapper_attributes' => [
          'colspan' => 2,
        ],
